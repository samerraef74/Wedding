...
// Import the chat controller (adjust path as needed)
import chatController from "../controllers/admin/chats.js";

// other routes...

router.get('/admin/chats/:id', chatController.chat_get);
...
router.get('/admin/chats/:id', chatController.chat_get);
router.post('/admin/chats/message', chatController.chat_post);
